// Non-web stub for PushNotificationService - used on native platforms
// This allows the code to compile without firebase or browser dependencies
...
class PushNotificationService extends ChangeNotifier {
  ...
  Future<void> initialize() async {
    ...
    _isInitialized = true;
    if (kDebugMode) {
      debugPrint('PushNotificationService: Not supported on native platforms');
    }
    notifyListeners();
  }
